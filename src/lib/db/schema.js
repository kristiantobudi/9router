...
export const TABLES = {
  ...
  providerLimitEvents: {
    ...
    indexes: [
      "CREATE INDEX IF NOT EXISTS idx_ple_ts ON providerLimitEvents(timestamp DESC)",
      "CREATE INDEX IF NOT EXISTS idx_ple_provider ON providerLimitEvents(provider)",
    ],
  },
};
